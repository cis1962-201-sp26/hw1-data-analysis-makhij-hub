...
I had the built in VS code autofill on when I started doing the project. Eventually I turned it off because I found it annoying, and it kept recommending me code that was not intuitive and not the way that I wanted to/knew how to solve the problems.
